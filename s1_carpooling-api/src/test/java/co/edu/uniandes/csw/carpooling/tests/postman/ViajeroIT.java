...
public class ViajeroIT {
     private static final String COLLECTION = "Viajero Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_carpooling-api.war")//War del modulo api
                ...
                .addPackage(ViajeroDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
